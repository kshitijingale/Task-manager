                ...
                (search) ? (
                    ...
                    <>
                        <div className='flex items-center mb-[30px] w-[300px] mx-[auto] justify-between border border-[#000] rounded py-[5px] px-[10px]'>
                            <input className='w-[80%] focus:outline-none' placeholder='Search a task....' value={searchText} onChange={(e) => setSearchText(e.target.value)} type='text' />
                        ...
                        <div className='flex justify-evenly mb-[40px]'>
                            <input value={todoTitle} onKeyDown={(e) => inputHandler(e)} onChange={(e) => setTodoTitle(e.target.value)} placeholder='Create a Task list.....' className='text-[20px] border-[2px] focus:outline-none 
              pl-[8px] rounded' />
